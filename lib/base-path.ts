 ...
 *
 * next/link・next/image・next/script は Next が basePath を自動で付けるので
 * 何もしなくてよい。付かないのは「文字列としてブラウザに渡すパス」——
 * CSS の url()、`new Image().src`、`fetch()` のURL、<link rel> の href など。
 * それらだけ withBasePath() を通す。
 *
